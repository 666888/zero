...
<div class="wrap">
    ...
    <div class="login_page">
        ...
        <div class="yxreg_conn clearfix">
			...
			<sf:form method="post" action = "/agsignup" modelAttribute="agent" onsubmit="return che();">
				<ul>
					<li>
						<div id="codetip" class="errtips"></div>
						<div class="yxform_in">
							<i class="iuser"></i>
							<sf:input class="ipt" maxlength="20" placeholder="登录码" path="name" />
							<div class="ipt_txt">代理账号</div>
					...
					<li>
						...
						<div class="yxform_in">
							<i class="iuser"></i>
							<sf:input class="ipt" maxlength="20" placeholder="真实姓名" path="realName" />
							<div class="ipt_txt">真实姓名</div>
							<i class="iclose" style=""></i>
						</div>
						<sf:errors path="realName" />
						<i class="iright" style="display:none"></i>
					</li>
					<li>
