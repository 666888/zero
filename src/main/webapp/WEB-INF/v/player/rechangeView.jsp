			...
			<div class="wrap_w clearfix">
				<div class="top_r">
					<div class="logined clearfix">
						...
						<div class="msg_box">
							<a target="_blank"
								href="http://bbs.subic888.com/home.php?mod=space&do=pm"> <i></i>
								消息
							</a> <a class="total_msg" style="display: none;"
								href="http://bbs.subic888.com/home.php?mod=space&do=pm"> <span></span>
							</a>
						</div>
						<div class="exit_box">
			...
			<table cellspacing="1" cellpadding="0" width="100%" border="0"
				...
				<tbody>
					<tr height="20" align="left">
						<td colspan="4"><a class="current" href="#">在线存款</a>--<a
							class="current1" href="#">汇款记录</a>--<a
							class="current2" href="#">取款记录</a>--<a
							class="current3" href="#">真人记录</a></td>
					</tr>
